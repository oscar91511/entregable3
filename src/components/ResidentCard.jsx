      ...
      <section className=" border-[1px] p-2 shadow-green-500 shadow-lg border-green-500">
        ...
        <ul className=" ">
          ...
          <li className="">
            ...
            <span className="text-[9px] pl-1 uppercase">{residentInfo?.origin.name}</span>
          </li>
          <li className="">
            <span  className="text-lime-300 text-[10px] uppercase font-bold">Times appear:</span>
            <span className="text-[12px] pl-4 uppercase font-bold">{residentInfo?.episode.length}</span>
          </li>
