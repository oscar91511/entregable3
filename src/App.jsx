...
const handleSubmit = (e) => {
  ...
  return (
    <div className =" App font-['Fira_Code'] text-white max-sm-[370px] mx-auto bg-[url(/images/bg-green.jpg)]  py-4 min-h-screen">
     ...
     <div className="-translate-y-[40%]">
      ...
      <form onSubmit={handleSubmit} className="-translate-y-[50%]">
        ...
        <h2 className="font-sans-serif font-['Fira_Code'] hover:text-black hover:bg-dark-green text-green-300 text-3xl mt-16 text-center">¡ Welcome to the crazy universe !</h2>
      </form>
     </header>
